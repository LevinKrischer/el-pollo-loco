class PickupManager {
     ...
     */
     handleBottlePickup(index) {
        ...
        this.world.uiManager.updateBottleStatusBar(this.bottleCount, this.world.maxBottleInventory);
    }
     ...
     */
     handleCoinPickup(index) {
        ...
        this.world.uiManager.updateCoinStatusBar(this.coinCount, this.world.maxCoins);
    }
}
